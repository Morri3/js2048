...
var QueryRef = exports.QueryRef = function (_AbstractRef) {
  ...
  function QueryRef(path, value) {
    ...
    return _possibleConstructorReturn(this, (QueryRef.__proto__ || Object.getPrototypeOf(QueryRef)).call(this, { path: path, value: value, spec: new QueryRefSpec() }));
  }
...
var QueryRefSpec = exports.QueryRefSpec = function (_AbstractRefSpec) {
  ...
  function QueryRefSpec() {
    ...
    return _possibleConstructorReturn(this, (QueryRefSpec.__proto__ || Object.getPrototypeOf(QueryRefSpec)).call(this, 'json-query', 'https://www.npmjs.com/package/json-query'));
  }
  ...
  _createClass(QueryRefSpec, [{
    ...
    value: function matches(rel) {
      ...
      return (0, _jsonQuery2.default)(rel).key !== undefined;
    }
  }, {
    key: 'follow',
