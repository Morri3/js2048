...
var PointerRef = exports.PointerRef = function (_AbstractRef) {
  ...
  function PointerRef(path, value) {
    ...
    return _possibleConstructorReturn(this, (PointerRef.__proto__ || Object.getPrototypeOf(PointerRef)).call(this, { path: path, value: value, spec: new PointerRefSpec() }));
  }
...
var PointerRefSpec = exports.PointerRefSpec = function (_AbstractRefSpec) {
  ...
  function PointerRefSpec() {
    ...
    return _possibleConstructorReturn(this, (PointerRefSpec.__proto__ || Object.getPrototypeOf(PointerRefSpec)).call(this, 'json-pointer', 'http://tools.ietf.org/html/draft-ietf-appsawg-json-pointer-08'));
  }
  ...
  _createClass(PointerRefSpec, [{
    ...
    value: function matches(rel) {
      ...
      try {
        return _typeof(_jsonpointer2.default.compile(rel)) === 'object';
      } catch (e) {
        return false;
      }
    }
