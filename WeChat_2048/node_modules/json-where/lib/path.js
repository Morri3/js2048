...
var PathRef = exports.PathRef = function (_AbstractRef) {
  ...
  function PathRef(path, value) {
    ...
    return _possibleConstructorReturn(this, (PathRef.__proto__ || Object.getPrototypeOf(PathRef)).call(this, { path: path, value: value, spec: new PathRefSpec() }));
  }
...
var PathRefSpec = exports.PathRefSpec = function (_AbstractRefSpec) {
  ...
  function PathRefSpec() {
    ...
    return _possibleConstructorReturn(this, (PathRefSpec.__proto__ || Object.getPrototypeOf(PathRefSpec)).call(this, 'json-path', 'http://goessner.net/articles/JsonPath/'));
  }
